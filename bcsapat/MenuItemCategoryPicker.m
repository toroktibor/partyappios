...
#import "MenuItemCategoryPicker.h"
#import "Session.h"

@interface MenuItemCategoryPicker ()

@end

@implementation MenuItemCategoryPicker
@synthesize types,typePicker,result;
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component {
    ...
    [[Session getInstance]setMenuItemCategory:result];
